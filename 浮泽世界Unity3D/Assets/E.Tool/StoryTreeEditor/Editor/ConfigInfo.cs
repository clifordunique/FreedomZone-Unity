...
namespace E.Tool
{
    ...
    public class ConfigInfo : ScriptableObject
    {
        ...
        [Header("资源文件夹")]
        public string StoryTreeFolder = "Assets/E.Tool/StoryTreeEditor/Assets/StoryTrees";
        public string StoryNodeFolder = "Assets/E.Tool/StoryTreeEditor/Assets/StoryNodes";
        public string StoryContentFolder = "Assets/E.Tool/StoryTreeEditor/Assets/StoryContents";
        ...
        public void Reset()
        {
            StoryTreeFolder = "Assets/E.Tool/StoryTreeEditor/Assets/StoryTrees";
            StoryNodeFolder = "Assets/E.Tool/StoryTreeEditor/Assets/StoryNodes";
            StoryContentFolder = "Assets/E.Tool/StoryTreeEditor/Assets/StoryContents";
