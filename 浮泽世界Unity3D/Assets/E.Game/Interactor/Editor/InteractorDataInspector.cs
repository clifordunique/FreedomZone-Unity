...
namespace E.Game
{
    ...
    {
        private InteractorData Data;

        private void OnEnable()
        {
            Data = (InteractorData)target;
        }
        public override void OnInspectorGUI()
        {
            ...
            //静态信息
            SerializedProperty m_ThisName = so.FindProperty("m_ThisName");
            ...
            SerializedProperty m_Volume = so.FindProperty("m_Volume");
            SerializedProperty m_Quality = so.FindProperty("m_Quality");
            ...
            EditorGUILayout.PropertyField(m_ThisName, new GUIContent("名称"));
            ...
            EditorGUILayout.PropertyField(m_Volume, new GUIContent("体积"));
            EditorGUILayout.PropertyField(m_Quality, new GUIContent("质量"));
            if (m_IsContainer.boolValue)
            {
