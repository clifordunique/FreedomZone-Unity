    ...
    public class SaveManager : Manager<SaveManager>
    {
        ...
        public void LoadGame()
        {
            if (File.Exists(m_SavePath))
            {
                ...
                CharacterManager.Singleton.Player.GetComponent<PlayerData>().PlayerName = save.PlayerName;
        ...
        private Save CreateSaveStruct()
        {
            Save save = new Save
            {
                ID = 1,
                Time = DateTime.Now,
                PlayerName = CharacterManager.Singleton.Player.GetComponent<PlayerData>().PlayerName,
