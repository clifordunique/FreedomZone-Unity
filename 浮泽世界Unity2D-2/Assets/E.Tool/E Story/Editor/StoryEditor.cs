...
namespace E.Tool
{
    ...
    public class StoryEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.TextField("全节点通过百分比", (Story.AllNodesPassPercentage * 100).ToString("f2") + "%"); 
            EditorGUILayout.TextField("全结局解锁百分比", (Story.AllEndingNodesPassPercentage * 100).ToString("f2") + "%");
