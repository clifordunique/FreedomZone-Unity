...
public abstract partial class Entity : NetworkBehaviour
{
    ...
    {
        // addon system hooks
        Utility.InvokeMany(typeof(Entity), this, "Awake_");
    }
    ...
    public override void OnStartServer()
    {
        ...
        // addon system hooks
        Utility.InvokeMany(typeof(Entity), this, "OnStartServer_");
    }
    ...
    void Update()
    {
        ...
        if (IsWorthUpdating())
        {
            ...
            if (agent.velocity != Vector2.zero)
                lookDirection = Utility.OrthonormalVector2(agent.velocity, lookDirection);
            else if (Target != null)
                lookDirection = Utility.OrthonormalVector2(Target.transform.position - transform.position, lookDirection);

            // addon system hooks
            Utility.InvokeMany(typeof(Entity), this, "Update_");
        }
    ...
    public virtual void DealDamageAt(Entity entity, int amount, float stunChance = 0, float stunTime = 0)
    {
        ...
        // addon system hooks
        Utility.InvokeMany(typeof(Entity), this, "DealDamageAt_", entity, amount);
    }
    ...
    void RpcOnDamageReceived(int amount, DamageType damageType)
    {
        ...
        // addon system hooks
        Utility.InvokeMany(typeof(Entity), this, "OnDamageReceived_", amount, damageType);
    }
    ...
    protected virtual void OnDeath()
    {
        ...
        // addon system hooks
        Utility.InvokeMany(typeof(Entity), this, "OnDeath_");
    }
