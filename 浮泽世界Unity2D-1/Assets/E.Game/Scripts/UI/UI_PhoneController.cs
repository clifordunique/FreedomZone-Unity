...
namespace E.Game
{
    public class UI_PhoneController : UI_Controller
    {
        [Header("UI组件")]
        ...
        private void Update()
        {
            if (Input.GetKeyUp(KeyCode.P) & !UIManager.Singleton.IsShowChat)
            {
                if (m_Animator.GetBool("IsShowPhone"))
                {
        ...
        {
            m_Animator.SetBool("IsShowPhone", IsShow);
